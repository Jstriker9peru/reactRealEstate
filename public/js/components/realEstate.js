...
var listingsData = [{
    ...
    homeType: 'Ranch',
    image: 'https://pmcvariety.files.wordpress.com/2017/03/inagarten_nyc_fi.jpg?w=670'
}, {
    address: '35532 Thorough Ave.',
    city: 'Patterson',
    state: 'NJ',
    rooms: 5,
    price: 265000,
    ...
    extras: ['elevator', 'gym'],
    homeType: 'Studio',
    image: 'https://media.expedia.com/hotels/13000000/12640000/12638800/12638766/29a7da70_z.jpg'
}, {
    address: '20211 Medioc Ave.',
    city: 'Dallas',
    state: 'TX',
    rooms: 4,
    price: 304000,
    ...
    homeType: 'Apartment',
    image: 'https://www.heartmilanapartments.com/wp-content/uploads/Heart-Milan-Apartments-home.jpg'
}];
    ...
    value: function filteredData() {
      ...
      if (this.state.neighborhood != "All") {
        newData = newData.filter(function (item) {
          return item.city == _this3.state.neighborhood;
        });
      }
